# -*- coding: utf-8 -*-
"""
Created on Thu Aug 15 21:18:31 2019
...
charac_copy =  charac_copy.replace('\t','')
charac_copy =  charac_copy.replace(' ','')
first_names = list(charac_copy)
last_names1 = ['赵', '钱', '孙', '李', '周', '吴', '郑', '王', '冯', '陈', '褚', '卫', '蒋', '沈', '韩', '杨', '朱', '秦', '尤', '许',
...
last_names2 = ["百里", "北堂", "北野", "淳于", "成公", "陈生", "端木", "东方", "东郭", "东野", "东门", "第二", "第五", "大狐", "公孙", "公冶", "公羊",
                 ...
                 "刘付", "刘谭", "陆费", "陆叶", "钱王","钱赖", "巫许", "吴刘", "吴沈", "有琴", "张包", "张简", "钟任", "章项", "单于", "叱干", "叱利",
                 "独孤", "赫连", "呼延", "贺兰", "夹谷", "吉胡", "敬花", "慕容", "万俟", "纳兰", "拓跋", "秃发", "完颜", "宇文", "尉迟", "长孙"]

first_names_sample = ['的', '一', '是', '了', '我', '不', '人', '在', '他', '有', '这', '个', '上', '们', '来', '到', '时', '大', '地', '为',
...
def random_chinese_name():
    ...
    :return:
    """
    with open('name_total'+'.txt','w',encoding='utf-8') as f:
        for case_number in range(2,5):
            if case_number == 2:
                    for last_name in last_names1:
            ...
            if case_number == 3:   
                    for last_name in last_names1:
                        for first_name in first_names:
                            name = '{} {} {}'.format(last_name, first_name, random.choice(first_names_sample))
                            
                            f.write(name + '\n')
                            print(name)
            if case_number == 4:
                    for last_name in last_names2:
                        for first_name in first_names:
                            name = '{} {} {}'.format(' '.join(list(last_name)), random.choice(first_names_sample), random.choice(first_names_sample))
                            f.write(name + '\n')
                            print(name)
